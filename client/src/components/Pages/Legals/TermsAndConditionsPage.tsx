  ...
  return (
    <div className={"container"}>
      ...
      <div className={"text"}>
        ...
        <p>
          Welcome to <b>AirRanging</b> (“Company”, “we”, “our”, “us”)!
        </p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use of
          our website located at <b>airranging.com.ar</b> (together or
          individually “Service”) operated by <b>AirRanging</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b>airizzutodev@gmail.com</b> so we can try to find a solution. These
        ...
        <p>
          ...
          following the unsubscribe link or by emailing at airizzutodev@gmail.com.
        </p>
        ...
        <p>
          AirRanging has the right but not the obligation to monitor and edit all
          Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of AirRanging or used with permission. You may not distribute, modify,
        ...
        <p>
          ...
          AirRanging and its licensors. Service is protected by copyright,
        ...
        <p>
          ...
          to airizzutodev@gmail.com, with the subject line: “Copyright
        ...
        <p>
          You can contact our Copyright Agent via email at airizzutodev@gmail.com.
        </p>
        <p>
          12. <b>Error Reporting and Feedback</b>
        </p>
        <p>
          You may provide us either directly at airizzutodev@gmail.com or via
        ...
        <p>
          ...
          are not owned or controlled by AirRanging.
        </p>
        <p>
          AirRanging has no control over, and assumes no responsibility for the
        ...
        <p>
          ...
          email: <b>airizzutodev@gmail.com</b>.
        </p>
      </div>
    </div>
  );
