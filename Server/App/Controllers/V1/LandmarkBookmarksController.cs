...
namespace App.Controllers.V1
{
    ...
    /// <para> GetUserBookmarkedLandmarkId  - GET    -  api/bookmarks/5      </para>
    /// <para> SaveLandmarkId               - POST   -  api/bookmarks/5      </para>
    /// <para> UnsaveLandmarkId             - DELETE -  api/bookmarks/5      </para>
    /// </summary>
    [ApiController]
    [Route("/api/bookmarks")]
